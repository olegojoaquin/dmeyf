...
hs <- makeParamSet( 
  makeNumericParam("learning_rate",    lower= 0.013 , upper=    0.01300001),
  makeIntegerParam("min_data_in_leaf", lower= 100    , upper= 101),
  makeIntegerParam("num_leaves",       lower=20   , upper= 21),
  makeNumericParam("num_iterations",       lower= 430, upper=    432),
  makeNumericParam("max_bin",       lower= 4, upper=    6)
        )
