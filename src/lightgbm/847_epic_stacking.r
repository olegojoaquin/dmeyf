...
setwd("/home/joaquin/Documents/Data-Mining/DMEyF/" )
...
karch_dataset    <- "./datasets/dataset_stacking_v004.csv.gz"   #este dataset se genero en el script 812_dataset_epic.r
...
hs <- makeParamSet( 
         ...
         makeNumericParam("lambda_l1",       lower= 0.000, upper=    1.0),
         makeNumericParam("lambda_l2",       lower= 0.000, upper=    1.0),
