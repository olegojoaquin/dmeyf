...
switch ( Sys.info()[['sysname']],
         ...
         Linux   = { directory.root  <-  "/home/joaquin/Documents/Data-Mining/DMEyF/" } #Google Cloud
       )
...
kexperimento  <- "E1026"   #NA si se corre la primera vez, un valor concreto si es para continuar procesando

kscript           <- "682_lgb_prob_auto"
karch_generacion  <- "./datasets/paquete_premium_202009_ext2.csv"
karch_aplicacion  <- "./datasets/paquete_premium_202011_ext2.csv"
...
hs <- makeParamSet( 
  ...
  makeNumericParam("max_bin",       lower= 5, upper=    200)
)
