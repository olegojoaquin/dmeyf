...
directory.root  <-  "/home/joaquin/Documents/Data-Mining/DMEyF/"  #Google Cloud
...
best20 <- c("ctrx_quarter","cpayroll_trx","mtarjeta_visa_consumo",      
             "mcuentas_saldo","mprestamos_personales","mcaja_ahorro",               
             "Visa_status","Visa_mpagominimo","mactivos_margen",            
             "ctarjeta_visa_transacciones","mcomisiones_mantenimiento","cproductos",                 
             "mtransferencias_recibidas","mcuenta_corriente","ccallcenter_transacciones",  
             "tcallcenter","mpasivos_margen","cprestamos_personales",      
             "ccajas_otras","mtarjeta_master_consumo"   )
...
AgregarVariables  <- function( dataset )
{
  ...
  #Juego con cantidad y montos de productos ahorro
  dataset[ , cacc_cantidad           := ccuenta_corriente +ccaja_ahorro]
  dataset[ , cacc_monto              := mcaja_ahorro +  mcaja_ahorro_adicional + mcaja_ahorro_dolares + mcuenta_corriente + mcuenta_corriente_adicional]
  dataset[ , cacc_monto_norm         := cacc_monto / mcuentas_saldo ]
  
  #Juego con cantidad de seguros, separando por alto valor (Vivienda,auto) y bajo valor (vida,accidentes_personales)
  dataset[ , seg_cantidad_seguros    := cseguro_vida + cseguro_auto + cseguro_vivienda + cseguro_accidentes_personales ]
  dataset[ , seg_cantidad_av         := cseguro_auto + cseguro_vivienda  ]
  dataset[ , seg_cantidad_bv         := cseguro_vida + cseguro_accidentes_personales ]
  
  #Juego con cantidad de prestamos
  ...
  dataset[ , inv_ratio_vista         := inv_monto_total / cacc_monto ]
  dataset[ , inv_ratio_saldo         := inv_monto_total / mcuentas_saldo ]
  
  #Joaco Ratios que no tienen sentido
  
  dataset[ , ratio_ctrx_quarter_cpayroll_trx := ctrx_quarter/cpayroll_trx ]
  dataset[ , ratio_ctrx_quarter_mtarjeta_visa_consumo := ctrx_quarter/mtarjeta_visa_consumo ]
  dataset[ , ratio_ctrx_quarter_mcuentas_saldo := ctrx_quarter/mcuentas_saldo ]
  dataset[ , ratio_ctrx_quarter_mprestamos_personales := ctrx_quarter/mprestamos_personales ]
  dataset[ , ratio_ctrx_quarter_mcaja_ahorro := ctrx_quarter/mcaja_ahorro ]
  #dataset[ , ratio_ctrx_quarter_mtarjeta_visa_consumo := ctrx_quarter/mtarjeta_visa_consumo ]
  dataset[ , ratio_ctrx_quarter_Visa_mpagominimo := ctrx_quarter/Visa_mpagominimo ]
  dataset[ , ratio_ctrx_quarter_mactivos_margen := ctrx_quarter/mactivos_margen ]
  dataset[ , ratio_ctrx_quarter_ctarjeta_visa_transacciones := ctrx_quarter/ctarjeta_visa_transacciones ]
  dataset[ , ratio_ctrx_quarter_mcomisiones_mantenimiento := ctrx_quarter/mcomisiones_mantenimiento]
  dataset[ , ratio_ctrx_quarter_cproductos := ctrx_quarter/cproductos ]
  dataset[ , ratio_ctrx_quarter_mtransferencias_recibidas := ctrx_quarter/mtransferencias_recibidas ]
  dataset[ , ratio_ctrx_quarter_mcuenta_corriente := ctrx_quarter/mcuenta_corriente ]
  dataset[ , ratio_ctrx_quarter_ccallcenter_transacciones := ctrx_quarter/ccallcenter_transacciones ]
  dataset[ , ratio_ctrx_quarter_tcallcenter:= ctrx_quarter/tcallcenter ]
  dataset[ , ratio_ctrx_quarter_mpasivos_margen := ctrx_quarter/mpasivos_margen ]
  dataset[ , ratio_ctrx_quarter_cprestamos_personales := ctrx_quarter/cprestamos_personales ]
  dataset[ , ratio_ctrx_quarter_ccajas_otras := ctrx_quarter/ccajas_otras ]
  dataset[ , ratio_ctrx_quarter_mtarjeta_master_consumo := ctrx_quarter/mtarjeta_master_consumo ]
  

  
  dataset[ , ratio_cpayroll_trx_mtarjeta_visa_consumo := cpayroll_trx/mtarjeta_visa_consumo ]
  dataset[ , ratio_cpayroll_trx_mcuentas_saldo := cpayroll_trx/mcuentas_saldo ]
  dataset[ , ratio_cpayroll_trx_mprestamos_personales := cpayroll_trx/mprestamos_personales ]
  dataset[ , ratio_cpayroll_trx_mcaja_ahorro := cpayroll_trx/mcaja_ahorro ]
  #dataset[ , ratio_cpayroll_trx_mtarjeta_visa_consumo := cpayroll_trx/mtarjeta_visa_consumo ]
  dataset[ , ratio_cpayroll_trx_Visa_mpagominimo := cpayroll_trx/Visa_mpagominimo ]
  dataset[ , ratio_cpayroll_trx_mactivos_margen := cpayroll_trx/mactivos_margen ]
  dataset[ , ratio_cpayroll_trx_ctarjeta_visa_transacciones := cpayroll_trx/ctarjeta_visa_transacciones ]
  dataset[ , ratio_cpayroll_trx_mcomisiones_mantenimiento := cpayroll_trx/mcomisiones_mantenimiento]
  dataset[ , ratio_cpayroll_trx_cproductos := cpayroll_trx/cproductos ]
  dataset[ , ratio_cpayroll_trx_mtransferencias_recibidas := cpayroll_trx/mtransferencias_recibidas ]
  dataset[ , ratio_cpayroll_trx_mcuenta_corriente := cpayroll_trx/mcuenta_corriente ]
  dataset[ , ratio_cpayroll_trx_ccallcenter_transacciones := cpayroll_trx/ccallcenter_transacciones ]
  dataset[ , ratio_cpayroll_trx_tcallcenter:= cpayroll_trx/tcallcenter ]
  dataset[ , ratio_cpayroll_trx_mpasivos_margen := cpayroll_trx/mpasivos_margen ]
  dataset[ , ratio_cpayroll_trx_cprestamos_personales := cpayroll_trx/cprestamos_personales ]
  dataset[ , ratio_cpayroll_trx_ccajas_otras := cpayroll_trx/ccajas_otras ]
  dataset[ , ratio_cpayroll_trx_mtarjeta_master_consumo := cpayroll_trx/mtarjeta_master_consumo ]
