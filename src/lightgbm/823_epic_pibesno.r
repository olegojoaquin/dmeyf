...
directory.root <- "/home/joaquin/Documents/Data-Mining/DMEyF/" 
...
hs <- makeParamSet( 
  makeNumericParam("learning_rate",    lower= 0.051 , upper=    0.05100001),
  makeIntegerParam("min_data_in_leaf", lower= 4000    , upper= 4001),
  makeIntegerParam("num_leaves",       lower=20   , upper= 21),
  makeNumericParam("num_iterations",       lower= 100, upper=    102),
  makeNumericParam("max_bin",       lower= 14, upper=    16)
        )
