...
switch ( Sys.info()[['sysname']],
         ...
         Linux   = { directory.root   <-  "/home/joaquin/Documents/Data-Mining/DMEyF/" }  #Entorno Google Cloud
       )
...
karch_generacion  <- "./datasetsOri/paquete_premium_202009_1.csv"
karch_aplicacion  <- "./datasetsOri/paquete_premium_202011_1.csv"
